        ...
        <div className="min-h-screen bg-[rgb(235,237,244)] dark:bg-[rgb(0,5,43)] relative z-0">
            ...
            <main className={`${mobileMenuOpen ? "pointer-events-none" : ""} relative z-10`} style={{ paddingTop: "80px" }}>
                            ...
                            <AnimatedOnScroll delay={0.2}>
                                <div className="relative w-full overflow-hidden mb-6">
                                    <div
                                        ...
                                        style={{
                                            background: "linear-gradient(90deg, rgba(255, 255, 255, 0) 0%, #0C74FF 50%, rgba(255, 216, 41, 0) 100%)",
                                        }}
                                    ></div>
                            ...
                            <AnimatedOnScroll delay={0.2}>
                                <Card className="w-full flex flex-col md:flex-row justify-between items-center gap-4 p-4 md:p-12 rounded-2xl md:rounded-3xl shadow-sm max-sm:bg-white dark:bg-[#080d32] backdrop-blur-xl">
                                    ...
                                    <div className="w-full md:w-[30%] flex items-center justify-end gap-3">
                                        <Card className="flex-shrink-0 flex items-center justify-center p-2 h-12 w-12 max-sm:bg-white dark:bg-gray-900/80 dark:backdrop-blur-md">
                ...
                <div className="container mx-auto px-4 max-w-7xl">
                    ...
                    <section className="flex flex-col w-full gap-8 md:mt-42 mt-8">
                        <AnimatedOnScroll delay={0.2}>
                            <FireHeadline
                        ...
                        <div className="flex flex-col md:flex-row gap-6 w-full items-start mt-2 md:mt-12">
                            <AccordionWithCard faqs={faqs1} />
                            <AnimatedOnScroll delay={0.2} className="md:w-7/12 lg:w-5/12 w-full">
                                <Card className="rounded-3xl p-6 gap-8 items-center  max-sm:bg-white w-full dark:bg-[#080d32] backdrop-blur-xl">
                                    <div>
                    ...
                    {/* Promotion Section */}
                    <section className="w-full py-2 mt-12 md:py-24">
                            ...
                            <div className="my-12 w-full">
                                <div className="relative">
                                    <div className="hidden md:block w-[80%] mx-auto absolute top-[60px] left-0 right-0 h-1.5 bg-gray-800/10 dark:bg-gray-800/30 z-0 transform -translate-y-1/2" />
                                        <AnimatedOnScroll delay={0.2} className="w-full">
                    ...
                    <section className="flex flex-col w-full gap-8">
                        ...
                        <div className="flex flex-col md:flex-row gap-6 w-full items-start mt-2 md:mt-12">
                            <AnimatedOnScroll delay={0.2} className="md:w-7/12 lg:w-5/12 w-full">
                                <Card className="rounded-3xl p-6 gap-8 items-center w-full max-sm:bg-white dark:bg-[#080d32] backdrop-blur-xl">
                                    <div>
                                        <img src={PromotionImg} alt="PromotionImg" />
                                    </div>
                                    <div className="flex flex-col gap-4">
